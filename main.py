...
async def start(bot: Client, m: Message):
    await m.reply_text(
        f"ʜᴇʟʟᴏ👋\n\n❈ ɪ ᴀᴍ ᴛxᴛ ᴛᴏ ᴠɪᴅᴇᴏ ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ.\n\n❈ ғᴏʀ ᴜsᴇ ᴍᴇ sᴇɴᴅ /tushar2.</a>", reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/Tushar0125") ],
                    [
                    InlineKeyboardButton("❤️‍🔥ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ❤️‍🔥" ,url="https://t.me/AIM_AIIMS143") ],
                    [
                    InlineKeyboardButton("🦋ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🦋" ,url="https://t.me/txtuploaderupdate") ]                               
            ]))
